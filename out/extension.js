...
function activate(context) {
    ...
    sidebarProvider = new sidebarProvider_1.PetJudgeSidebarProvider(context.extensionUri);
    // Register sidebar webview
    context.subscriptions.push(vscode.window.registerWebviewViewProvider('petJudge.sidebarView', sidebarProvider));
    ...
    // Manual test trigger
    context.subscriptions.push(vscode.commands.registerCommand('petJudge.triggerPoop', () => {
        triggerPoop();
    }));
    // Toggle on/off
    context.subscriptions.push(vscode.commands.registerCommand('petJudge.toggleActive', () => {
        isActive = !isActive;
